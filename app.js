  ...
  sections: [
    {
      ...
      description: "Define your brand's core reason for existence and fundamental values",
      questions: [
        {
          id: 1,
          ...
          options: [
            { value: 5, text: "We have a clear, documented mission that guides all decisions" },
            { value: 4, text: "We have a mission statement that most team members know" },
            { value: 3, text: "We have a general idea but it's not formally documented" },
        ...
        },
        {
          id: 2,
          type: "rating",
          question: "How well do your core values align with your business practices?",
          scale: { min: 1, max: 5, labels: ["Not at all", "Poorly", "Somewhat", "Well", "Perfectly"] }
        },
        {
          id: 3,
          type: "multiple-choice",
          ...
          options: [
            { value: 5, text: "A clear purpose to solve specific problems or create positive impact" },
            { value: 4, text: "Passion for our industry and serving customers well" },
            { value: 3, text: "Providing quality products/services to the market" },
        ...
        },
        {
          id: 4,
          type: "checkbox",
          question: "Which elements are included in your brand purpose? (Select all that apply)",
          options: [
        ...
        },
        {
          id: 5,
          type: "rating",
          question: "How authentic does your brand purpose feel to your team and customers?",
          scale: { min: 1, max: 5, labels: ["Forced", "Somewhat artificial", "Neutral", "Genuine", "Completely authentic"] }
        },
        {
          id: 6,
          type: "multiple-choice",
          question: "How often do you reference your brand mission in business decisions?",
          options: [
            { value: 5, text: "Always - it's our primary decision-making filter" },
    ...
    },
    {
      ...
      description: "Identify and understand your ideal customers and market position",
      questions: [
        {
          id: 7,
          type: "multiple-choice",
          question: "How well do you understand your target audience's demographics?",
          options: [
            { value: 5, text: "We have detailed demographic profiles with specific data" },
            { value: 4, text: "We understand the basics like age, income, and location" },
            { value: 3, text: "We have general assumptions but limited data" },
            { value: 2, text: "We have some ideas but they're mostly guesswork" },
        ...
        },
        {
          id: 8,
          type: "rating",
          question: "How well do you understand your customers' pain points and needs?",
          scale: { min: 1, max: 5, labels: ["Not at all", "Poorly", "Somewhat", "Well", "Extremely well"] }
        },
        {
          id: 9,
          type: "checkbox",
          question: "Which research methods have you used to understand your audience? (Select all that apply)",
          options: [
        ...
        },
        {
          ...
          options: [
            { value: 5, text: "We have detailed personas with names, stories, and specific traits" },
            { value: 4, text: "We have solid personas covering key characteristics" },
            { value: 3, text: "We have basic customer segments identified" },
            { value: 2, text: "We have rough ideas about different customer types" },
        ...
        },
        {
          ...
          scale: { min: 1, max: 5, labels: ["Poorly", "Below average", "Average", "Well", "Extremely well"] }
        },
        {
          id: 12,
          type: "multiple-choice",
          question: "How do you gather ongoing feedback from your target market?",
          options: [
            { value: 5, text: "Multiple channels with regular, systematic feedback collection" },
    ...
    },
    {
      ...
      description: "Establish your brand's visual elements and design consistency",
      questions: [
        {
          id: 13,
          type: "multiple-choice",
          ...
          options: [
            { value: 5, text: "Perfectly captures our essence and is professionally designed" },
        ...
        },
        {
          id: 14,
          type: "rating",
          question: "How consistent is your visual identity across all materials?",
          scale: { min: 1, max: 5, labels: ["Very inconsistent", "Somewhat inconsistent", "Neutral", "Mostly consistent", "Completely consistent"] }
        },
        {
          id: 15,
          type: "checkbox",
          question: "Which visual brand elements do you have documented? (Select all that apply)",
          options: [
        ...
        },
        {
          ...
          options: [
            { value: 5, text: "Colors chosen strategically to evoke specific emotions and differentiate" },
            { value: 4, text: "Colors align with our brand personality and industry" },
            { value: 3, text: "Colors look good together but limited strategic thinking" },
            { value: 2, text: "Colors chosen based on personal preference" },
            { value: 1, text: "No defined color palette or random color usage" }
          ]
        },
        {
          id: 17,
          type: "rating",
          question: "How recognizable is your brand visually in the marketplace?",
          scale: { min: 1, max: 5, labels: ["Not recognizable", "Slightly recognizable", "Somewhat recognizable", "Easily recognizable", "Instantly recognizable"] }
        },
        {
          id: 18,
          type: "multiple-choice",
          question: "How well do your visual elements work across different media?",
          options: [
            { value: 5, text: "Excellent - works perfectly across print, digital, and merchandise" },
            { value: 4, text: "Good - works well in most applications" },
            { value: 3, text: "Adequate - some challenges in certain formats" },
            { value: 2, text: "Poor - significant issues across different media" },
            { value: 1, text: "Very poor - doesn't translate well to different formats" }
          ]
        }
      ]
    },
      ...
      questions: [
        {
          ...
          options: [
            { value: 5, text: "Fully documented with specific guidelines and examples" },
            { value: 4, text: "Well-defined with most team members understanding it" },
            { value: 3, text: "Generally understood but not formally documented" },
            { value: 2, text: "Inconsistent or unclear across different communications" },
        ...
        },
        {
          id: 20,
          type: "rating",
          question: "How consistent is your messaging across all communication channels?",
          scale: { min: 1, max: 5, labels: ["Very inconsistent", "Inconsistent", "Somewhat consistent", "Mostly consistent", "Completely consistent"] }
        },
        {
          id: 21,
          type: "checkbox",
          question: "Which key messages do you consistently communicate? (Select all that apply)",
          options: [
        ...
        },
        {
          id: 22,
          type: "multiple-choice",
          question: "How well does your brand storytelling engage your audience?",
          options: [
            { value: 5, text: "Compelling stories that create strong emotional connections" },
            { value: 4, text: "Good stories that resonate with our audience" },
            { value: 3, text: "Basic storytelling with some engagement" },
            { value: 2, text: "Limited storytelling or poor audience connection" },
        ...
        },
        {
          id: 23,
          type: "rating",
          question: "How authentic does your brand voice feel to your audience?",
          scale: { min: 1, max: 5, labels: ["Very artificial", "Somewhat artificial", "Neutral", "Authentic", "Very authentic"] }
        },
        {
          id: 24,
          type: "multiple-choice",
          question: "How well do your content and communications support your brand goals?",
          options: [
            { value: 5, text: "All content strategically aligned with brand and business objectives" },
            { value: 4, text: "Most content supports our brand strategy" },
            { value: 3, text: "Some content alignment but could be more strategic" },
            { value: 2, text: "Limited connection between content and brand goals" },
            { value: 1, text: "Content created without brand strategy consideration" }
          ]
        }
      ]
    },
    {
      ...
      description: "Execute and maintain brand consistency across all touchpoints",
      questions: [
        {
          id: 25,
          type: "multiple-choice",
          ...
          options: [
            { value: 5, text: "Complete guidelines covering all brand elements and applications" },
            { value: 4, text: "Good guidelines covering most important elements" },
        ...
        },
        {
          ...
          scale: { min: 1, max: 5, labels: ["Not trained", "Poorly trained", "Somewhat trained", "Well trained", "Expert level"] }
        },
        {
          id: 27,
          type: "checkbox",
          question: "Which touchpoints consistently reflect your brand? (Select all that apply)",
          options: [
        ...
        },
        {
          ...
          options: [
            { value: 5, text: "Systematic monitoring with regular audits and feedback loops" },
            { value: 4, text: "Regular checks and updates to maintain consistency" },
        ...
        },
        {
          id: 29,
          type: "rating",
          question: "How well does your brand adapt to new channels and opportunities?",
          scale: { min: 1, max: 5, labels: ["Very poorly", "Poorly", "Adequately", "Well", "Extremely well"] }
        },
        {
          id: 30,
          type: "multiple-choice",
          ...
          options: [
            { value: 5, text: "Strategic, planned evolution with stakeholder input and testing" },
            { value: 4, text: "Thoughtful updates when needed with team consultation" },
...
const scoringLevels = {
  excellent: { min: 120, max: 150, label: "Brand Excellence", description: "Your brand strategy is well-developed and comprehensive" },
  good: { min: 90, max: 119, label: "Strong Foundation", description: "Your brand has solid fundamentals with room for refinement" },
  developing: { min: 60, max: 89, label: "Developing Brand", description: "Your brand is taking shape but needs strategic focus" },
  early: { min: 0, max: 59, label: "Early Stage", description: "Your brand needs foundational development across key areas" }
};

// DOM Elements
let startQuizBtn, prevBtn, nextBtn, retakeQuizBtn, downloadResultsBtn;
let progressContainer, progressFill, progressText;
let sectionBadge, sectionTitle, sectionDescription, questionContainer, questionIndicator;
...
function getTotalQuestionNumber() {
  ...
  for (let i = 0; i < currentState.currentSectionIndex; i++) {
    totalQuestions += quizData.sections[i].questions.length;
  }
  return totalQuestions + currentState.currentQuestionIndex + 1;
}

function updateQuizDisplay() {
  const currentSection = quizData.sections[currentState.currentSectionIndex];
  const currentQuestion = currentSection.questions[currentState.currentQuestionIndex];
  
  // Update section header
  sectionBadge.textContent = `Section ${currentState.currentSectionIndex + 1} of 5`;
  sectionTitle.textContent = currentSection.title;
  sectionDescription.textContent = currentSection.description;
  
  // Update question indicator
  questionIndicator.textContent = `Question ${currentState.currentQuestionIndex + 1} of ${currentSection.questions.length}`;
  ...
  progressFill.style.width = `${Math.max(0, progressPercentage)}%`;
  progressText.textContent = `${currentQuestionNumber - 1} of ${totalQuestions} questions`;
  
  // Render question
  renderQuestion(currentQuestion);
  
  // Update navigation buttons
  prevBtn.disabled = currentState.currentSectionIndex === 0 && currentState.currentQuestionIndex === 0;
  
  // Check if this is the last question
  const isLastSection = currentState.currentSectionIndex === quizData.sections.length - 1;
  const isLastQuestion = currentState.currentQuestionIndex === currentSection.questions.length - 1;
  
  if (isLastSection && isLastQuestion) {
    nextBtn.textContent = 'View Results';
  } else if (currentState.currentQuestionIndex === currentSection.questions.length - 1) {
...
function updateNextButtonState() {
  const currentQuestion = quizData.sections[currentState.currentSectionIndex].questions[currentState.currentQuestionIndex];
  ...
  if (currentQuestion.type === 'checkbox') {
    const answer = currentState.answers[currentQuestion.id];
    nextBtn.disabled = !answer || answer.length === 0;
  } else {
...
function restoreAnswer(question, savedAnswer) {
  switch(question.type) {
    case 'multiple-choice':
      const radioOption = document.querySelector(`input[name="question_${question.id}"][value="${savedAnswer}"]`);
      if (radioOption) {
      ...
      break;
    case 'rating':
      const ratingItem = document.querySelector(`.rating-item[data-value="${savedAnswer}"]`);
      if (ratingItem) {
    ...
    case 'checkbox':
      if (Array.isArray(savedAnswer)) {
        savedAnswer.forEach(value => {
          const checkboxOption = document.querySelector(`input[name="question_${question.id}"][value="${value}"]`);
          if (checkboxOption) {
...
function saveCurrentAnswer() {
  ...
  switch(currentQuestion.type) {
    case 'multiple-choice':
      const selectedRadio = document.querySelector(`input[name="question_${currentQuestion.id}"]:checked`);
    ...
    case 'rating':
      ...
      answer = selectedRating ? parseInt(selectedRating.dataset.value) : undefined;
      break;
    case 'checkbox':
      const selectedCheckboxes = document.querySelectorAll(`input[name="question_${currentQuestion.id}"]:checked`);
  ...
  if (answer !== undefined) {
    ...
    delete currentState.answers[currentQuestion.id];
  }
...
function previousQuestion() {
  if (currentState.currentQuestionIndex > 0) {
    ...
    currentState.currentQuestionIndex = quizData.sections[currentState.currentSectionIndex].questions.length - 1;
  }
...
function displayResults() {
  ...
  const sectionResultsHtml = quizData.sections.map(section => {
  ...
  const recommendations = generateRecommendations(currentState.totalScore, currentState.sectionScores);
...
function generateRecommendations(totalScore, sectionScores) {
  ...
  const sectionPerformance = Object.entries(sectionScores).map(([id, score]) => ({
    id: parseInt(id),
    score,
  ...
  weakestSections.forEach(section => {
    ...
    switch(section.id) {
      case 1:
        recommendations.push("Develop a clear, documented mission statement that guides all business decisions");
        break;
      case 2:
        recommendations.push("Invest in market research to better understand your target audience and their needs");
        break;
      case 3:
        recommendations.push("Create comprehensive brand guidelines to ensure visual consistency across all touchpoints");
        break;
      case 4:
        recommendations.push("Define your brand voice and develop key messages that resonate with your audience");
        break;
      case 5:
        recommendations.push("Implement systematic brand monitoring and team training to maintain consistency");
        break;
    }
  });
  ...
  if (totalScore < 60) {
    recommendations.push("Consider working with a brand strategist to develop a comprehensive brand foundation");
    recommendations.push("Start with the basics: mission, target audience, and visual identity before expanding");
  } else if (totalScore < 90) {
    recommendations.push("Focus on documentation and systematic implementation of your brand elements");
    recommendations.push("Develop training materials to ensure team alignment on brand standards");
  } else if (totalScore < 120) {
    recommendations.push("Fine-tune your brand implementation and explore advanced brand strategy techniques");
    recommendations.push("Consider brand audits to identify areas for optimization and growth");
  }
